...
function CollectionManagement() {
  ...
  const [addNewVisible, setAddNewVisible] = reactExports.useState(false);
  const collection = falcon.collection({
    collection: "detection_context"
  });
  const fetchEntries = async () => {
    ...
    try {
      ...
      if (data?.resources?.length) {
        const promises = data.resources.map(objectKey => collection.read(objectKey).then(entry => ({
          ...entry,
          objectKey
        })));
  ...
  const handleUpdate = async () => {
    ...
    try {
      await collection.write(editEntry.objectKey, {
        ...
        content: purify.sanitize(editEntry.content),
        type: editEntry.type,
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await collection.write(key, {
        ...
        content: purify.sanitize(newEntry.content),
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "container mx-auto mt-8 px-4 pb-16 max-w-6xl"
  }, /*#__PURE__*/React.createElement("h1", {
    className: "text-3xl font-bold mb-8 text-gray-800 pb-4 text-center"
  }, "Detection Context Management"), error && /*#__PURE__*/React.createElement("div", {
    className: "bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-lg mb-6 shadow-sm flex justify-between items-center"
  ...
  })), "Create Entry"), addNewVisible && /*#__PURE__*/React.createElement("div", {
    className: "bg-white p-8 rounded-xl shadow-lg mb-10 border border-gray-100"
    ...
    strokeWidth: 2,
    d: "M12 6v6m0 0v6m0-6h6m-6 0H6"
  })), "Add New Entry"), /*#__PURE__*/React.createElement("div", {
    className: "space-y-5"
  }, /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-2 gap-6"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-medium text-gray-700 mb-2"
  }, "Composite ID"), /*#__PURE__*/React.createElement("input", {
    type: "text",
    ...
    strokeWidth: 2,
    d: "M12 6v6m0 0v6m0-6h6m-6 0H6"
  })), "Create Entry")))), /*#__PURE__*/React.createElement("div", {
    className: "space-y-6"
  }, /*#__PURE__*/React.createElement("div", {
  ...
  })), "Existing Entries"), /*#__PURE__*/React.createElement("span", {
    className: "bg-indigo-100 text-indigo-800 text-sm px-3 py-1 rounded-full font-medium"
  }, entries.length, " ", entries.length === 1 ? "entry" : "entries")), loading ? /*#__PURE__*/React.createElement("div", {
  ...
  }, "No entries found"), /*#__PURE__*/React.createElement("p", {
    className: "text-gray-500"
  }, "Create your first entry using the form above.")) : /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 gap-6"
  }, entries.map((entry, index) => /*#__PURE__*/React.createElement("div", {
    key: index,
  ...
  }, editEntry && editEntry.objectKey === entry.objectKey ? /*#__PURE__*/React.createElement("div", {
    className: "p-6 space-y-5"
  }, /*#__PURE__*/React.createElement("h3", {
    className: "text-lg font-semibold text-gray-800 mb-4"
  }, "Editing Entry"), /*#__PURE__*/React.createElement("div", {
    className: "grid grid-cols-1 md:grid-cols-2 gap-6"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    className: "block text-sm font-medium text-gray-700 mb-2"
  }, "Title"), /*#__PURE__*/React.createElement("input", {
  ...
  })), entry.type), /*#__PURE__*/React.createElement("div", {
  ...
  })), "ID: ", entry.compositeId)), /*#__PURE__*/React.createElement("h3", {
    ...
    dangerouslySetInnerHTML: {
      __html: purify.sanitize(entry.content)
    }
  })))))))));
}
...
function App() {
  ...
  }, /*#__PURE__*/React.createElement(CollectionManagement, null)));
}
